...
public class PanelFlujoMaximo extends JPanel {
	...
	private static final long serialVersionUID = 7413321332574642481L;
	...
	public void calcularFM() {
		...
		lblNewLabel_3.setText("El flujo máximo entre la estacion " + origen.getNombre() + " y " + destino.getNombre()
				+ " es de: " + grafo.flujoMaximo1(origen, destino) + ".");
