...
public class PanelAgregarTareaMantenimiento extends JPanel {
	...
	private static final long serialVersionUID = -6322707548476691681L;
	...
	public TareaMantenimiento getTareaCreada() throws FechaFinMenorFechaInicioException {
		...
		if (this.dateChooser.getDate() == null && this.dateChooser_1.getDate() == null) {
			...
			return new TareaMantenimiento(e, null,
					this.dateChooser_1.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate(),
					this.textArea.getText());
		} else if (this.dateChooser_1.getDate() == null) {
			return new TareaMantenimiento(e,
					this.dateChooser.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate(), null,
					this.textArea.getText());
		} else {
			return new TareaMantenimiento(e,
					this.dateChooser.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate(),
					this.dateChooser_1.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate(),
					this.textArea.getText());
		}
