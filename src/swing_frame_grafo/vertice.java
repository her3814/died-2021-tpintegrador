...
/**
 * Clase de paquete representando un vertice de un grafo dibujable. No se debe
...
class vertice {
	...
	public vertice(Estacion estacion, int x, int y) {
		color = estacion.getEstado().equals(EstadoEstacionEnum.OPERATIVA) ? new Color(45, 87, 44)
				: new Color(76, 0, 19);
		this.x = x - 20;
		this.y = y - 20;
