...
public class PanelAgregarLinea extends JPanel {
	...
	private static final long serialVersionUID = 2903340392260671777L;
	...
	public PanelAgregarLinea() {
		...
		comboBox.setModel(new javax.swing.DefaultComboBoxModel<>(colores.toArray()));
